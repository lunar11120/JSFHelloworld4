 ...
 * @author Theam
 */
@Component("google_Oauth2Config")
public class Google_Oauth2Config {
    
    private static final Logger LOGGER = Logger.getLogger(Google_Oauth2Config.class.getName());
    ...
    public String toString() {
        return "Google_Oauth2Config{" + "clientId=" + clientId + ", clientSecret=" + clientSecret + ", redirectUri=" + redirectUri + ", authorizationUri=" + authorizationUri + ", tokenUri=" + tokenUri + ", userInfoUri=" + userInfoUri + ", scope=" + scope + ", responseType=" + responseType + ", debugInfo=" + debugInfo + '}';
    }
